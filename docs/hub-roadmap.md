...
**Status:** v1.1.0 — see [platform/](./platform/) and [CHANGELOG.md](../CHANGELOG.md)  
...
## 2. What exists today (v1.1.0)

| Component | Role | Status |
|-----------|------|--------|
| `artifacts/telehealth-survey/src/platform/` | Hub shell: `/`, system admin, prospectus UI | **Implemented** |
...
| Prospectus tables + `/research/prospectus` | Research intake + dual approval gate | **Implemented** |
...
| H8 | Research prospectus intake + dual approval | **Done** — see [platform/research-prospectus.md](./platform/research-prospectus.md) |
...
| 2026-07-05 | v1.1.0 research prospectus system shipped |
